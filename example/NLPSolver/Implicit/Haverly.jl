...
@NLconstraint(jm1, x1 + x2 - x3 - x6 == 0.0)
@NLconstraint(jm1, 0.03*x1 + 0.01*x2 - x3*x9 - x6*x9 == 0.0)
@NLconstraint(jm1, x3 + x4 - x5 == 0.0)
@NLconstraint(jm1, x6 + x7 - x8 == 0.0)
@NLconstraint(jm1, x3*x9 + 0.02*x4 - 0.025*x5 <= 0)
@NLconstraint(jm1, x6*x9 + 0.02*x7 - 0.015*x8 <= 0)
