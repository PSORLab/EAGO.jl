...
# Convert method assumes that the children connectivity used in tracer has
# has been converted to an area. Holds a single parent value as is used in JuMP.
...
# Defines primitives for associative terms
