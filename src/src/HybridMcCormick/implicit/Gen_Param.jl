function PSMCg_Kernel!(h::Function,hj::Function,z_mc::Vector{HybridMC{N,V,T}},
                       aff_mc::Vector{HybridMC{N,V,T}},p_mc::Vector{HybridMC{N,V,T}},
                       x_mc::Vector{HybridMC{N,V,T}},opt::mc_opts{T}) where {N,V<:AbstractInterval,T<:AbstractFloat}
