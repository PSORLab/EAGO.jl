...
SIP_opts() = SIP_opts(1E-3,100,1,1.5,false,20,1,EAGO_NLPSolver(),EAGO_NLPSolver(),EAGO_NLPSolver(),[],[],[],[],[],"Normal",1E-4,Expr[],Expr[])
SIP_opts(X) = SIP_opts(1E-3,100,1,1.5,false,20,1,X,X,X,[],[],[],[],[],"Normal",1E-4,Expr[],Expr[])
