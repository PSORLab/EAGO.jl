...
o1,o2 = EAGO.acos_rev(ma,mb)
@test isapprox(o1.lo,1.0,atol=1E-4)
@test isapprox(o1.hi,2.0,atol=1E-4)
@test isapprox(o2.lo,Inf,atol=1E-4)
...
@test EAGO.mul_revDR(1.0,b,c) == EAGO.mul_revDR(promote(1.0,b,c)...)
@test EAGO.exp_revDR(1.0,b) == EAGO.exp_revDR(promote(1.0,b)...)
@test EAGO.sinh_rev(1.0,b) == EAGO.sinh_rev(promote(1.0,b)...)
@test EAGO.cosh_rev(1.0,b) == EAGO.cosh_rev(promote(1.0,b)...)
@test EAGO.tanh_rev(1.0,b) == EAGO.tanh_rev(promote(1.0,b)...)
@test EAGO.asinh_rev(1.0,b) == EAGO.asinh_rev(promote(1.0,b)...)
@test EAGO.acosh_rev(1.0,b) == EAGO.acosh_rev(promote(1.0,b)...)
@test EAGO.atanh_rev(1.0,b) == EAGO.atanh_rev(promote(1.0,b)...)
@test EAGO.step_rev(1.0,b) == EAGO.step_rev(promote(1.0,b)...)
@test EAGO.sign_rev(1.0,b) == EAGO.sign_rev(promote(1.0,b)...)
@test EAGO.exp2_rev(1.0,b) == EAGO.exp2_rev(promote(1.0,b)...)
@test EAGO.exp10_rev(1.0,b) == EAGO.exp10_rev(promote(1.0,b)...)
@test EAGO.log2_rev(1.0,b) == EAGO.log2_rev(promote(1.0,b)...)
@test EAGO.log10_rev(1.0,b) == EAGO.log10_rev(promote(1.0,b)...)
@test EAGO.one_rev(1.0,b) == EAGO.one_rev(promote(1.0,b)...)
@test EAGO.zero_rev(1.0,b) == EAGO.zero_rev(promote(1.0,b)...)
