...
X1 = SMCg{2,Interval{Float64},Float64}(mid(xI1),mid(xI1),a,a,xI1,false)
X2 = SMCg{2,Interval{Float64},Float64}(mid(xI2),mid(xI2),a,a,xI2,false)
X3 = SMCg{2,Interval{Float64},Float64}(mid(xI3),mid(xI3),a,a,xI3,false)
X4 = SMCg{2,Interval{Float64},Float64}(mid(xI4),mid(xI4),a,a,xI4,false)

P1 = SMCg{2,Interval{Float64},Float64}(mid(pI1),mid(pI1),b,b,pI1,false)
P2 = SMCg{2,Interval{Float64},Float64}(mid(pI2),mid(pI2),b,b,pI2,false)
P3 = SMCg{2,Interval{Float64},Float64}(mid(pI3),mid(pI3),b,b,pI3,false)
P4 = SMCg{2,Interval{Float64},Float64}(mid(pI4),mid(pI4),b,b,pI4,false)
