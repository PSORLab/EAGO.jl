...
@testset "Test Asinh" begin
    ...
    mBox = mid.(xIBox)
    X = SMCg{2,Interval{Float64},Float64}(0.3,0.3,a,a,xIBox[1],false)
    Xn = SMCg{2,Interval{Float64},Float64}(-0.3,-0.3,a,a,-xIBox[1],false)
    Xz = SMCg{2,Interval{Float64},Float64}(2.0,2.0,a,a,xIBox[2],false)
    Xz1 = SMCg{2,Interval{Float64},Float64}(-2.0,-2.0,a,a,-xIBox[2],false)
...
@testset "Test Atanh" begin
    ...
    X = SMCg{2,Interval{Float64},Float64}(0.3,0.3,a,a,xIBox[1],false)
    Xn = SMCg{2,Interval{Float64},Float64}(-0.3,-0.3,a,a,-xIBox[1],false)
    Xz = SMCg{2,Interval{Float64},Float64}(0.2,0.2,a,a,xIBox[2],false)
    Xz1 = SMCg{2,Interval{Float64},Float64}(-0.2,-0.2,a,a,-xIBox[2],false)
