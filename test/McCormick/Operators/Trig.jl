...
@testset "Test Tan" begin
    ...
    mBox = mid.(xIBox)
    X = SMCg{2,Interval{Float64},Float64}(0.6,0.6,a,a,xIBox[1],false)
    Xn = SMCg{2,Interval{Float64},Float64}(-0.8,-0.8,a,a,-xIBox[1],false)
    Xz = SMCg{2,Interval{Float64},Float64}(-0.3,-0.3,a,a,xIBox[2],false)
    Xerr = SMCg{2,Interval{Float64},Float64}(0.6,0.6,a,a,Interval(-4.5,5.0),false)
