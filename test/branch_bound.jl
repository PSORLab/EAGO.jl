@testset "Test Stack Management Functions" begin
    ...
    x._working_problem._variable_info = [EAGO.VariableInfo(false, true, true, false, true, 1.0, 2.0),
                                         EAGO.VariableInfo(false, true, true, false, true, 2.0, 6.0)]
    x._lower_solution = [1.4, 5.3]
    y = EAGO.NodeBB(Float64[1.0,5.0], Float64[2.0,6.0], Bool[false, false], true, -Inf, Inf, 2, 1,1, EAGO.BD_NONE, 1, 0.1)
    x._current_node = y
    EAGO.branch_node!(x)
    ...
    empty!(x._stack)
    push!(x._stack, EAGO.NodeBB(Float64[1.0,5.0], Float64[2.0,6.0], Bool[false, false], true, -4.0, 1.0, 2, 1, 1, EAGO.BD_NONE, 1, 0.1))
    push!(x._stack, EAGO.NodeBB(Float64[2.0,5.0], Float64[5.0,6.0], Bool[false, false], true, -5.0, 4.0, 2, 1, 1, EAGO.BD_NONE, 1, 0.1))
    push!(x._stack, EAGO.NodeBB(Float64[2.0,3.0], Float64[4.0,5.0], Bool[false, false], true, -2.0, 3.0, 2, 1, 1, EAGO.BD_NONE, 1, 0.1))
    EAGO.node_selection!(x)
    ...
    @test ~isless(EAGO.NodeBB(Float64[1.0,5.0], Float64[2.0,6.0], Bool[false, false], true, -4.0, 1.0, 2, 1, 1, EAGO.BD_NONE, 1, 0.1), 
                  EAGO.NodeBB(Float64[2.0,5.0], Float64[5.0,6.0], Bool[false, false], true, -5.0, 4.0, 2, 1, 1, EAGO.BD_NONE, 1, 0.1))
    @test length(EAGO.NodeBB(Float64[1.0,5.0], Float64[2.0,6.0], Bool[false, false], true, -4.0, 1.0, 2, 1, 1, EAGO.BD_NONE, 1, 0.1)) == 2
    diamx = EAGO.diam(EAGO.NodeBB(Float64[1.0,5.0], Float64[2.0,7.0], Bool[false, false], true, -4.0, 1.0, 2, 1,  1, EAGO.BD_NONE, 1, 0.1))
    @test diamx[1] == 1.0
    @test diamx[2] == 2.0
...
@testset "Node Access Functions" begin
    x = EAGO.NodeBB(Float64[1.0,5.0], Float64[2.0,6.0], Bool[false, false], true, -3.4, 2.1, 2, 1, 1, EAGO.BD_NONE, 1, 0.1)
    emptyx = EAGO.NodeBB(Float64[7.0,5.0], Float64[1.0,6.0], Bool[false, false], true, -3.4, 2.1, 2, 1, 1, EAGO.BD_NONE, 1, 0.1)
    ...
    x1 = EAGO.NodeBB(Float64[1.0,5.0], Float64[3.0,6.0], Bool[false, false], true, -3.4, 2.1, 2, 1, 1, EAGO.BD_NONE, 1, 0.1)
    x2 = EAGO.NodeBB(Float64[0.9,5.0], Float64[2.0,6.0], Bool[false, false], true, -3.4, 2.1, 2, 1, 1, EAGO.BD_NONE, 1, 0.1)
    x3 = copy(x)
    x4 = EAGO.NodeBB(x)
